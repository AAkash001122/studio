        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16 text-center md:text-left">
            ...
            <p className="font-sans text-gray-400 text-lg max-w-2xl">
              Ready to create something cinematic? Fill out the form below or
              reach us directly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="space-y-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                {/* Name Input */}
                <div className="group">
                  <label className="block font-sans text-gray-500 text-xs uppercase tracking-widest mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="ad-film" className="bg-[#141414]">
                        Advertising Film
                      </option>
                      <option value="branded-content" className="bg-[#141414]">
                        Branded Content
                      </option>
                      <option value="original" className="bg-[#141414]">
                        Original Content
                      </option>
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-10 py-4 bg-[#00E676] text-black font-bold font-sans rounded-full hover:shadow-[0_0_20px_rgba(0,230,118,0.4)] transition-all duration-300 flex items-center justify-center gap-3 group"
                >
                  Send Message
                  <Send
                    size={18}
            ...
            <div className="space-y-10">
              ...
              <div className="bg-[#141414] border border-white/5 p-8 rounded-3xl">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 group cursor-pointer">
                    ...
                    <a
                      ...
                      className="font-sans text-white text-lg group-hover:text-[#00E676] transition-colors"
                    >
                ...
                <div className="mt-10 pt-6 border-t border-white/10 flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#00E676] hover:text-[#00E676] transition-all"
                  >
                    <Instagram size={18} />
                  </a>
                  <a
