  ...
  return (
    <section className="relative w-full bg-[#0a0a0a] py-32 md:py-40 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <button
          onClick={() => navigate("/contact")} // 3. Navigation Logic
          className="group relative px-10 py-4 bg-[#00E676] text-black text-lg font-bold rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(0,230,118,0.5)]"
        >
